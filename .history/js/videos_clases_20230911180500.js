...
data.forEach((video, i) => {
    let video_element = `
                <div class="video" data-id="${video.id}">
                    <img src="./img/img_clases/play.svg" alt="">
                    <p>${i + 1 > 9 ? i + 1 : '0' + (i + 1)}. </p>
...
videos[0].querySelector('img').src = './img/img_clases/pause.svg';
...
videos.forEach(selected_video => {
    selected_video.onclick = () => {
        ...
        for (all_videos of videos) {
            ...
            all_videos.querySelector('img').src = './img/img_clases/play.svg';

        }

        selected_video.classList.add('active');
        selected_video.querySelector('img').src = './img/img_clases/pause.svg';
