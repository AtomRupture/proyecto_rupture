...
<div class="flex-container">
	...
	<div class="flex-slide home">
		<div class="flex-title flex-title-home"><a href="bajar_peso.php">Bajar Peso</a></div>
		<div class="flex-about flex-about-home"><p>Click here to navigate to the home section of the website</p></div>
	</div>
	<div class="flex-slide about">
		<div class="flex-title"><a href="Ganar_masa.php">Ganar Masa</a></div>
		<div class="flex-about"><p>Click here to navigate to the About section of the website</p></div>
	</div>
	<div class="flex-slide work">
		<div class="flex-title"><a href="Mantener_peso.php">Mantener peso</a></div>
	...
	<div class="flex-slide home">
		<div class="flex-title flex-title-home"><a href="subir_peso.php">Subir Peso</a></div>
		<div class="flex-about flex-about-home"><p>Click here to navigate to the home section of the website</p></div>
	</div>
