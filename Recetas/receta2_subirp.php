...
<head>
    ...
    <link rel="stylesheet" href="../css/rect2_subirp.css">
...
<div class="main-content">
  <div class="navigation">Sandwich de ternera por Atom Rupture</div>
  <div class="pie-image"></div>
  <div class="pie-recipe">
    <div class="pie-recipe__title">
      <div class="pie-name">
         SANDWICH DE<br/> TERNERA</div>
    ...
    <div class="pie-recipe__ingredients">
      <div class="pie-recipe__ingredients__item">
        <h4>Ingredientes</h4>
        <ul>
          <li>Filete de ternera (100 g)</li>
          <li>2 cucharaditas de aceite de coco</li>
          <li>50 ml de vinagre balsámico</li>
        <li>¼ de cucharadita de sal marina y pimienta negra</li>
        <li>1 cebolla roja pequeña (cortada en rodajas muy finas y largas)</li>
        <li>5 g de parmesano</li>
        <li>1 puñado de rúcula</li>
        <li>2 cucharaditas de salsa de mostaza y miel baja en grasas</li>
        <LI>2 rebanadas de pan de chapata integral</LI>
    ...
    <div class="pie-recipe__steps"> Primero, calienta una sartén antiadherente grande a fuego medio con una cucharadita de aceite de coco. </div>
    <div class="pie-recipe__number">2</div>
    <div class="pie-recipe__steps">Añade las rodajas de cebolla roja a la sartén y cocina durante unos 3-4 minutos, moviendo de vez en cuando. Añade el vinagre balsámico, baja el fuego al mínimo y tapa la sartén. Cocina durante otros 20 minutos más.</div>
    <div class="pie-recipe__number">3</div>
    <div class="pie-recipe__steps">Una vez que la cebolla se haya reblandecido y haya empezado a caramelizar, empieza a cocinar el filete. Pon una sartén a fuego alto con una cucharadita de aceite de coco. Cuando la sartén esté muy caliente y casi empiece a humear, añade el filete. El tiempo de cocinado depende te tu gusto por comer la carne. </div>
    <div class="pie-recipe__number">4</div>
    <div class="pie-recipe__steps">Una vez cocinado el filete, sácalo de la sartén y déjalo apartado a un lado en un plato para que repose durante 1 o 2 minutos. Baja el fuego a la mitad.</div>

    <div class="pie-recipe__number">5</div>
    <div class="pie-recipe__steps">Añade ahora las rebanadas de pan chapata en la sartén en la que estaba el filete y tuéstalo durante 1-2 minutos. Una vez tostado, saca el pan de la sartén y déjalo en un plato. </div>
    <div class="pie-recipe__number">6</div>
    <div class="pie-recipe__steps">Por último, corta el filete a tiras finas y empieza a rellenar el sándwich. Añade también la cebolla caramelizada, la rúcula y el parmesano, y echa por encima la salsa de mostaza y miel baja en grasa.</div>
    ...
    <div class="pie-recipe__tips">
      ...
      <h4> Sándwich de ternera para ganar masa muscular</h4>
      <div class="pie-recipe__tips__text">¿Sabías que hay vida más allá del arroz con pollo? Si estás cansado de comer siempre lo mismo, toma nota de este suculento sándwich de ternera para ganar masa muscular.</div>
    </div>
  </div>
