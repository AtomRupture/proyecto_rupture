...
<head>
    ...
    <link rel="stylesheet" href="../css/rect4_subirp.css">
    <link rel="stylesheet" href="../css/style.css">
    <title>Sandwich de ternera</title>
</head>
<?php include '../php/modulos/header.php' ?>
<body>

<div class="main-content">
  <div class="navigation">Hamburguesas rellenas de mozzarella por Atom Rupture</div>
  <div class="pie-image"></div>
  <div class="pie-recipe">
    <div class="pie-recipe__title">
      <div class="pie-name">
         HAMBURGUESAS RELLENAS <br/>DE MOZZARELLA</div>
    ...
    <div class="pie-recipe__ingredients">
      <div class="pie-recipe__ingredients__item">
        ...
        <li>2 cucharaditas de mostaza en polvo</li>
        <li>½ cucharadita de pimienta de cayena en polvo</li>
        <li>1 huevo</li>
        <li>50 g de pan rallado</li>
        <LI>Sal al gusto</LI>
        <li>1 bola de mozzarella light (partida en 4 trozos)</li>

        </ul>
        <h4>MAS INGREDIENTES</h4>
        <ul>
    ...
    <div class="pie-recipe__steps"> Primero, Precalienta el horno a 200° C. </div>
    <div class="pie-recipe__number">2</div>
    <div class="pie-recipe__steps">Calienta un poco de aceite de oliva en una sartén y añade la cebolla y el ajo. Deja que se cocinen durante unos minutos, removiendo de vez en cuando hasta que se pochen y se doren. Una vez dorados, quítalos de la sartén y viértelos en un bol grande.</div>
    <div class="pie-recipe__number">3</div>
    <div class="pie-recipe__steps">Vierte también en el mismo bol la carne picada, la mostaza en polvo, la pimienta de cayena, el huevo, el pan rallado y una pizca de sal. Mezcla bien todos los ingredientes con la ayuda de una paleta de cocina o incluso con las manos si lo prefieres. </div>
    <div class="pie-recipe__number">4</div>
    <div class="pie-recipe__steps">Una vez bien mezclados todos los ingredientes, coge un cuarto de la mezcla aproximadamente y dale forma de hamburguesa. Pon un cuarto de la bola de mozzarella sobre la hamburguesa y envuelve la mozzarella con la carne para que esta quede justo en el centro. Repite este mismo proceso con las cuatro hamburguesas.</div>

    <div class="pie-recipe__number">5</div>
    <div class="pie-recipe__steps">A continuación, calienta un poco de aceite de oliva en una sartén y cocina las hamburguesas un par de minutos aproximadamente por cada lado o hasta que estén bien doradas (este paso ayudará a que no pierdan la humedad durante el horneado). Una vez doradas, ponlas en una bandeja para el horno y hornea durante unos 20 minutos.
 </div>
 <div class="pie-recipe__number">6</div>
    <div class="pie-recipe__steps">Pasado el tiempo de horneado, saca la bandeja del horno y monta tus hamburguesas como más te guste. Nosotros hemos utilizado panes de hamburguesa con semillas de sésamo, hojas de lechuga, rodajas de tomate y un generoso topping de nuestra deliciosa Salsa Sin Azúcar BBQ.
 </div>
    ...
    <div class="pie-recipe__tips">
      ...
      <h4> Pasta con salchichas cremosa y ligera</h4>
      <div class="pie-recipe__tips__text">¿Estás buscando nuevas recetas saludables para añadir variedad y color a tu dieta? Prueba esta receta de pasta con salchichas cremosa y ligera, te aseguramos que no te dejará indiferente.</div>
    </div>
  </div>
