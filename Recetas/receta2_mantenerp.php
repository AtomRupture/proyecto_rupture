...
<head>
    ...
    <link rel="stylesheet" href="../css/rect2_mantp.css">
...
<div class="main-content">
  <div class="navigation">Ensalada de garbanzos por Atom Rupture</div>
  <div class="pie-image"></div>
  <div class="pie-recipe">
    <div class="pie-recipe__title">
      <div class="pie-name">
         ENSALADA DE<br/> GARBANZOS</div>
    ...
    <div class="pie-recipe__ingredients">
      <div class="pie-recipe__ingredients__item">
        <h4>Ingredientes</h4>
        <ul>
          <li>75 ml de aceite de oliva</li>
          <li>35 ml de vinagre de vino blanco</li>
          <li>1 cucharada de zumo de limón</li>
        <li>1 pizca de sal</li>
        <li>1 pizca de pimienta negra</li>
        <li>1 puñado de perejil (picado)</li>
        <li>2 botes de garbanzos (enjuagados y escurridos)</li>
        <li>1 pepino (troceado)</li>
        <li>1 cebolla morada (en rodajas finas)</li>
        <li>1 pimiento rojo (troceado)</li>
        <li>200 g de aceitunas Kalamata (partidas)</li>
        <li>150 g de queso feta (troceado)</li>
    ...
    <div class="pie-recipe__steps"> En primer lugar, prepara el aliño añadiendo el aceite, el vinagre de vino blanco, el zumo de limón, la sal, la pimienta y el perejil picado en un bol pequeño. </div>
    <div class="pie-recipe__number">2</div>
    <div class="pie-recipe__steps">Mezcla bien para combinar todos los ingredientes y reserva el bol para más tarde.</div>
    <div class="pie-recipe__number">3</div>
    <div class="pie-recipe__steps">A continuación, añade los garbanzos escurridos, el pepino, el pimiento rojo, la cebolla roja, las aceitunas y el queso feta a un bol grande. </div>
    <div class="pie-recipe__number">4</div>
    <div class="pie-recipe__steps"> Vierte el aliño sobre todos los ingredientes y remueve bien para que se mezclen todos los sabores. Eso es todo.</div>

    <div class="pie-recipe__number">5</div>
    <div class="pie-recipe__steps"> Por último, puedes servir la ensalada en platos para comerla en el momento o repartirla en cuatro tuppers para tener comidas preparadas para varios días. </div>
    ...
    <div class="pie-recipe__tips">
      ...
      <h4> Ensalada de garbanzos</h4>
      <div class="pie-recipe__tips__text">Preparar comidas para toda la semana (lo que hoy conocemos como “meal prep”) no tiene por qué llevarte todo un día entero en la cocina, y un claro ejemplo de ello es esta sencilla y deliciosa ensalada de garbanzos.</div>
    </div>
  </div>
