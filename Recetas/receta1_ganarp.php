...
<head>
    ...
    <link rel="stylesheet" href="../css/rect1_ganarp.css">
...
<div class="main-content">
  <div class="navigation">Pollo con vegetales asados por Atom Rupture</div>
  <div class="pie-image"></div>
  <div class="pie-recipe">
    <div class="pie-recipe__title">
      <div class="pie-name">
         POLLO CON VEGETALES ASADOS<br/> Y QUINOA</div>
    ...
    <div class="pie-recipe__ingredients">
      <div class="pie-recipe__ingredients__item">
        <h4>Ingredientes</h4>
        <ul>
          <li>1 pechuga de pollo deshuesada y sin piel – fuente de proteínas magras</li>
          <li>1 calabacín mediano, cortado en rodajas gruesas</li>
          <li>½ pimiento rojo cortado en trozos</li>
        <li>½  cebolla morada cortada en rodajas</li>
        <li>½ taza de quinoa – fuente de carbohidratos saludables y proteínas magras</li>
    ...
    <div class="pie-recipe__steps"> Primero que todo, Precalienta el horno a fuego medio-alto. Mientras, pon a hervir 1 taza de agua en un recipiente. </div>
    <div class="pie-recipe__number">2</div>
    <div class="pie-recipe__steps">Cuando el agua hierva, agrega la quinoa previamente lavada y el diente de ajo picado en el agua. Tapa el recipiente mientras se cocina a fuego lento, hasta que se consuma todo el agua y la quinoa esté cocida. Aproximadamente 15-20 minutos.</div>
    <div class="pie-recipe__number">3</div>
    <div class="pie-recipe__steps">Mezcla los vegetales con aceite de oliva, romero, sal y pimienta en un tazón grande. </div>
    <div class="pie-recipe__number">4</div>
    <div class="pie-recipe__steps">Asa los vegetales en el horno durante unos 10-15 minutos hasta que estén tiernos y dorados.</div>

    <div class="pie-recipe__number">5</div>
    <div class="pie-recipe__steps">Mientras tanto, sazona las pechuga de pollo con sal y pimienta y hornear durante unos 15 minutos por cada lado, o hasta que estén cocidas por completo. </div>
    <div class="pie-recipe__number">6</div>
    <div class="pie-recipe__steps">Sirve el pollo con los vegetales asados y la quinoa.</div>
    <div class="pie-recipe__tips">
      ...
      <h4> Pollo al horno, con vegetales asados y quinoa</h4>
      <div class="pie-recipe__tips__text">Ideal para un almuerzo o cena post entrenamiento. 

Característica que distingue a esta receta: saciante</div>
    </div>
  </div>
