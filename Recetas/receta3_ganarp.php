...
<head>
    ...
    <link rel="stylesheet" href="../css/rect3_ganarp.css">
    <link rel="stylesheet" href="../css/style.css">
    <title>Estofado de pollo</title>
</head>
<?php include '../php/modulos/header.php' ?>
<body>

<div class="main-content">
  <div class="navigation">Estofado de pollo por Atom Rupture</div>
  <div class="pie-image"></div>
  <div class="pie-recipe">
    <div class="pie-recipe__title">
      <div class="pie-name">
         ESTOFADO DE<br/> POLLO</div>
    ...
    <div class="pie-recipe__ingredients">
      <div class="pie-recipe__ingredients__item">
        ...
        <li>1 apio (picado)</li>
        <li>700 ml de caldo de pollo</li>
        <li>500 g de patatas baby (cortadas por la mitad)</li>
    ...
    <div class="pie-recipe__steps"> Primero, pon a calentar una olla a fuego medio y derrite el aceite de coco. </div>
    <div class="pie-recipe__number">2</div>
    <div class="pie-recipe__steps">Añade las pechugas de pollo y deja que se cocinen durante unos minutos por cada lado hasta que se vuelvan de color blanco (en lugar del típico color rosa). Este paso sirve para que la carne retenga la humedad antes de añadirla al resto del estofado.</div>
    <div class="pie-recipe__number">3</div>
    <div class="pie-recipe__steps">Saca las pechugas de pollo y déjalas apartadas en un plato por ahora. Añade las zanahorias, el apio, el ajo y la harina y remueve bien para mezclar las verduras con la harina.
 </div>
    <div class="pie-recipe__number">4</div>
    <div class="pie-recipe__steps">Añade las patatas baby, el caldo de pollo, el tomillo y salpimienta al gusto. Vuelve a remover la mezcla y añade de nuevo las pechugas de pollo a la olla.</div>

    <div class="pie-recipe__number">5</div>
    <div class="pie-recipe__steps">Tapa la olla con su tapa y deja hervir a fuego lento durante 15 minutos. </div>
    <div class="pie-recipe__number">6</div>
    <div class="pie-recipe__steps">Vuelve a sacar las pechugas de pollo y desmenúzalas en un plato con la ayuda de dos tenedores.</div>
    <div class="pie-recipe__number">7</div>
    <div class="pie-recipe__steps">Vierte el pollo desmenuzado de nuevo a la olla, añade el perejil picado y remueve bien.
Por último, sirve en un plato para disfrutarlo en el momento o guárdalo en tuppers para disfrutar de un delicioso y ligero estofado de pollo durante la semana.</div>
