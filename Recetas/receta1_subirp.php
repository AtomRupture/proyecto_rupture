...
<head>
    ...
    <link rel="stylesheet" href="../css/rect1_subirp.css">
...
<div class="main-content">
  <div class="navigation">Rollos de pollo rellenos por Atom Rupture</div>
  <div class="pie-image"></div>
  <div class="pie-recipe">
    <div class="pie-recipe__title">
      <div class="pie-name">
         ROLLO DE POLLO<br/> RELLENO</div>
    ...
    <div class="pie-recipe__ingredients">
      <div class="pie-recipe__ingredients__item">
        ...
        <ul>
          ...
          <li>2 cucharaditas de hierbas mixtas</li>
        <li>Sal y pimienta al gusto</li>
        <li>6-8 tomates secos</li>
        <li>60 g de queso cheddar bajo en grasa (rallado)</li>
        <li>200 g de espinacas tiernas</li>
        <li>100 g de pan rallado dorado</li>
        <LI>Spray de cocina bajo en calorías</LI>
      ...
      <div class="pie-recipe__ingredients__item">
        <h4>EXTRA</h4>
        <ul>
          <li>Ensalada fresca o tus verduras favoritas</li>
    ...
    <div class="pie-recipe__steps">Corta las pechugas de pollo por la mitad pero sin llegar a separar las dos mitades para que se queden unidas por el centro. Cubre las pechugas con film transparente y amásalas con un rodillo para aplanarlas.</div>
    <div class="pie-recipe__number">3</div>
    <div class="pie-recipe__steps">Sazona al gusto con cebolla en polvo, hierbas mixtas, sal y pimienta, y añade los ingredientes como si fuera una pizza: tomates secos, espinacas tiernas y una generosa cantidad de queso cheddar. </div>
    <div class="pie-recipe__number">4</div>
    <div class="pie-recipe__steps">Enrolla las pechugas de pollo en horizontal con mucho cuidado para hacer los dos rollitos grandes. Clava unos palillos a lo largo de los rollitos para que no se desmonten</div>

    <div class="pie-recipe__number">5</div>
    <div class="pie-recipe__steps">Reboza los rollitos de pollo con el pan rallado dorado, rocía con un poco de spray de cocina bajo en calorías y ponlos en una bandeja de horno cubierta con papel de hornear. Hornea durante 35 minutos o hasta que estén bien cocinados. </div>
    <div class="pie-recipe__number">6</div>
    <div class="pie-recipe__steps">Una vez sacados el horno, espera a que se enfríen para que puedas manipularlos, retira los palillos y corta cada rollo en rollitos más pequeños.</div>
    <div class="pie-recipe__number">7</div>
    <div class="pie-recipe__steps">Sirve los rollitos con una ensalada o con tus verduras favoritas, o si quieres una comida más completa, sírvelos con unos trozos de boniato.</div>
    <div class="pie-recipe__tips">
      ...
      <h4> Rollos de pollo rellenos</h4>
