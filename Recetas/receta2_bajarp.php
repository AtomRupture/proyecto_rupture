...
<head>
    ...
    <link rel="stylesheet" href="../css/rect2_bajarp.css">
    <link rel="stylesheet" href="../css/style.css">
    <title>Pollo al estilo mediterraneo</title>
</head>
<?php include '../php/modulos/header.php' ?>
<body>

<div class="main-content">
  <div class="navigation">Pollo al estilo mediterraneo por Atom Rupture</div>
  <div class="pie-image"></div>
  <div class="pie-recipe">
    <div class="pie-recipe__title">
      <div class="pie-name">
         POLLO AL ESTILO<br/>MEDITERRANEO CON ACEITUNAS Y ALCAPARRAS</div>
    ...
    <div class="pie-recipe__ingredients">
      <div class="pie-recipe__ingredients__item">
        ...
        <li>Unas hebras de azafran</li>
        <li>300ml de caldo de pollo</li>
        <li>media cucharada de pimenton dulce</li>
        <li>50g de aceitunas</li>
        <li>25g de alcaparras</li>
        <li>1 zumo de limon</li>
    ...
    <div class="pie-recipe__steps"> Para empezar, comenzaremos calentando una cazuela con el aceite y salteando el pollo hasta que esté dorado. </div>
    <div class="pie-recipe__number">2</div>
    <div class="pie-recipe__steps">Picamos las cebollas en trozos y los pimientos en tiras, así como los dientes de ajo menudos.</div>
    <div class="pie-recipe__number">3</div>
    <div class="pie-recipe__steps"> Sacamos una vez dorado el pollo de la cazuela, y sofreímos durante dos minutos el pimiento y la cebolla, añadimos 50 mililitros de agua, tapamos la olla y cocemos las hortalizas durante 10 minutos. </div>
    <div class="pie-recipe__number">4</div>
    <div class="pie-recipe__steps">Una vez que pase el tiempo agregamos los dientes de ajo picados, y ponemos la carne de nuevo en la cazuela.</div>
    <div class="pie-recipe__number">5</div>
    <div class="pie-recipe__steps">Añadimos el azafrán y el caldo de pollo, sazonamos con el pimentón y salpimentamos.</div>
    <div class="pie-recipe__number">6</div>
    <div class="pie-recipe__steps">Llevamos el líquido a ebullición y añadimos las aceitunas, las alcaparras y el zumo de limón.</div>
    <div class="pie-recipe__number">7</div>
    <div class="pie-recipe__steps">Cocemos con la olla destapada durante 20 minutos o hasta que esté la carne tierna. Adornamos al servir con unas hojas de albahaca fresca.</div>
    <div class="pie-recipe__tips">
      ...
      <h4>Pollo al estilo mediterraneo</h4>
