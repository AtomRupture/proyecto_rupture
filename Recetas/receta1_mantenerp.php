...
<head>
    ...
    <link rel="stylesheet" href="../css/rect1_mantp.css">
    <link rel="stylesheet" href="../css/style.css">
    <title>Tacos de lechuga con lentejas</title>
</head>
<?php include '../php/modulos/header.php' ?>
<body>

<div class="main-content">
  <div class="navigation">Tacos de lechuga con lentejas por Atom Rupture</div>
  <div class="pie-image"></div>
  <div class="pie-recipe">
    <div class="pie-recipe__title">
      <div class="pie-name">
         TACOS DE LECHUGA CON<br/> LENTEJAS</div>
    ...
    <div class="pie-recipe__ingredients">
      <div class="pie-recipe__ingredients__item">
        <h4>Ingredientes</h4>
        <ul>
          <li>8 hojas de lechuga frescas y firmes.</li>
          <li>¾ de taza de lentejas secas (180 g).</li>
          <li>1 cebolla.</li>
        <li>1 tomate.</li>
        <li>Aguacate pequeño.</li>
        <li>El zumo de ½ limón</li>
        <li>1 cucharada de aceite de oliva (10 ml).</li>
        <li>Sal y ají molido (al gusto).</li>
    ...
    <div class="pie-recipe__steps"> Lava las lentejas y ponlas a hervir en abundante agua hasta que ablanden. </div>
    <div class="pie-recipe__number">2</div>
    <div class="pie-recipe__steps">Una vez estén listas, déjalas reposar mientras rehogas en una sartén la cebolla picada con un poco de aceite de oliva y sal.</div>
    <div class="pie-recipe__number">3</div>
    <div class="pie-recipe__steps">Cuando la cebolla esté tierna, agrégale las lentejas cocidas y el ají molido. </div>
    <div class="pie-recipe__number">4</div>
    <div class="pie-recipe__steps">Retira el preparado del fuego y agrégale el zumo de limón</div>

    <div class="pie-recipe__number">5</div>
    <div class="pie-recipe__steps">A continuación, lava bien cada hoja de lechuga y ponlas en un plato. </div>
    <div class="pie-recipe__number">6</div>
    <div class="pie-recipe__steps">Ponles por encima la mezcla de lentejas y, por último, cúbrelas con unos cubos de aguacate y tomate fresco.</div>
    <div class="pie-recipe__tips">
      ...
      <h4> Tacos de lechuga con lentejas</h4>
      <div class="pie-recipe__tips__text">Tanto la lechuga como las lentejas te permiten disfrutar de cenas ligeras que cuidan tu peso y salud. Así pues, estos deliciosos tacos se convertirán en una de tus opciones favoritas para saciar el hambre a esta hora del día.</div>
    </div>
  </div>
