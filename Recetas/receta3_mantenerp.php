...
<head>
    ...
    <link rel="stylesheet" href="../css/rect3_mantp.css">
    <link rel="stylesheet" href="../css/style.css">
    <title>Filete de atun con boniato</title>
</head>
<?php include '../php/modulos/header.php' ?>
<body>

<div class="main-content">
  <div class="navigation">Filetes de atun por Atom Rupture</div>
  <div class="pie-image"></div>
  <div class="pie-recipe">
    <div class="pie-recipe__title">
      <div class="pie-name">
         FILETES DE ATUN<br/> CON BONIATO</div>
    ...
    <div class="pie-recipe__ingredients">
      <div class="pie-recipe__ingredients__item">
        <h4>Ingredientes atun</h4>
        <ul>
          <li>4 filetes de atún de 150 g</li>
          <li>1 cucharadita de sal marina gorda.</li>
          <li>1 cucharada de Aceite de Coco</li>
        <li>2 cucharadas de granos de pimienta rosa</li>


        </ul>
        <h4>Extra</h4>
        <ul>
          <li>Ensalada u hojas de espinaca</li>
          <li>1 limón (cortado en rodajas)</li>
        </ul>
      </div>
      <div class="pie-recipe__ingredients__item">
        <h4>Ingredientes boniatos</h4>
        <ul>
          <li>4 boniatos grandes</li>
          <li>1 cucharada de harina</li>
          <li>1/2 cucharadita de sal</li>
          <li>1/2 cucharadita de pimienta negra</li>
          <li>1/2 cucharada de Aceite de Coco (derretido)</li>
        </ul>
      </div>
    </div>
    ...
    <div class="pie-recipe__steps">Empezaremos preparando los boniatos. Lava los boniatos de uno en uno y pínchalos varias veces con un tenedor. Ponlos en un plato para microondas y mete el plato en el microondas a máxima temperatura durante 4-5 minutos, una vez pasado ese tiempo, saca el plato y deja que se enfríe durante uno o dos minutos.</div>
    <div class="pie-recipe__number">3</div>
    <div class="pie-recipe__steps">Cuando ya esté lo suficiente frío como para tocar los boniatos, córtalos en gajos. Espolvorea por encima la harina, la sal, la pimienta y vierte el aceite de coco derretido sobre los gajos. Mueve un poco los gajos para que se cubran bien con la mezcla, hará que queden más crujientes. Ahora ponlos en una bandeja para hornear y hornea a 200º C durante uno 15-20 minutos. </div>
    <div class="pie-recipe__number">4</div>
    <div class="pie-recipe__steps">Cuando los boniatos estén casi listos, empezamos a preparar los filetes de atún. Tritura los granos de pimienta con un mortero, y si no tienes mortero, puedes poner los granos sobre una tabla de cocina y aplastarlos con un rodillo. Salpimienta cada filete y pon una sartén grande a fuego alto con el aceite de coco.Salpimienta cada filete y pon una sartén grande a fuego alto con el aceite de coco.</div>

    <div class="pie-recipe__number">5</div>
    <div class="pie-recipe__steps">Cuando la sartén empiece a humear, añade los filetes de atún y cocínalos durante unos 45 segundos por cada lado si te gusta poco hecho. Si te gusta bien hecho, cocínalos unos 2 minutos por cada lado. </div>
    <div class="pie-recipe__number">6</div>
    <div class="pie-recipe__steps">Sirve con unas rodajas de limón y tus verduras favoritas, luego divide los filetes de atún con boniato en 4 tuppers.</div>
    <div class="pie-recipe__tips">
      ...
      <h4> Filete de atun con boniato</h4>
