...
<head>
    ...
    <link rel="stylesheet" href="../css/rect3_subirp.css">
...
<div class="main-content">
  <div class="navigation">Pasta con salchichas cremosa y ligera por Atom Rupture</div>
  <div class="pie-image"></div>
  <div class="pie-recipe">
    <div class="pie-recipe__title">
      <div class="pie-name">
         PASTA CON <br/>SALCHICHAS</div>
    ...
    <div class="pie-recipe__ingredients">
      <div class="pie-recipe__ingredients__item">
        ...
        <ul>
          ...
          <li>1 puerro (picado)</li>
          <li>2 dientes de ajo (picados)</li>
        <li>8 salchichas de cerdo bajas en grasa (cortadas)</li>
        <li>200 g de quark</li>
        <li>1 bote de tomate triturado</li>
        <li>240 g de pasta integral (cocida)</li>
        <li>1 cucharadita de copos de chile seco</li>
        <LI>Sal y pimienta al gusto</LI>
        <li>Un puñado de hojas frescas de albahaca</li>
    ...
    <div class="pie-recipe__steps"> Primero, Añade el aceite de coco en una sartén antiadherente grande a fuego medio/alto. Cuando el aceite esté derretido, añade el puerro picado y cocínalo durante 3-4 minutos, moviendo de vez en cuando. </div>
    <div class="pie-recipe__number">2</div>
    <div class="pie-recipe__steps">Añade el ajo y saltea durante otros dos minutos. Añade las salchichas y cocina durante 6-10 minutos, moviendo de vez en cuando hasta que estén bien doradas. Echa los copos de chile y salpimienta al gusto.</div>
    <div class="pie-recipe__number">3</div>
    <div class="pie-recipe__steps">Vierte el bote de tomate y remueve para mezclar todos los ingredientes. Deja que se caliente bien el tomate durante unos minutos y añade el quark, mezclando bien para conseguir una salsa sabrosa y cremosa. </div>
    <div class="pie-recipe__number">4</div>
    <div class="pie-recipe__steps">Por último, vierte la pasta hervida en la sartén y remueve para que se mezcle bien con la salsa.</div>

    <div class="pie-recipe__number">5</div>
    <div class="pie-recipe__steps">Pasados unos minutos, retira la sartén del fuego y reparte el contenido en cuatro tuppers, con unas hojitas frescas de albahaca por encima.
 </div>
