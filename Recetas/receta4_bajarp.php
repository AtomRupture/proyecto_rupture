...
<head>
    ...
    <link rel="stylesheet" href="../css/rect4_bajarp.css">
    <link rel="stylesheet" href="../css/style.css">
    <title>Batido de manzana verde con kiwi</title>
</head>
<?php include '../php/modulos/header.php' ?>
<body>

<div class="main-content">
  <div class="navigation">Batidos verdes por Atom Rupture</div>
  <div class="pie-image"></div>
  <div class="pie-recipe">
    <div class="pie-recipe__title">
      <div class="pie-name">
         BATIDO DE MANZANA VERDE<br/>CON KIWI</div>
    ...
    <div class="pie-recipe__steps">  Reunimos todos los ingredientes para preparar el batido de manzana verde con kiwi. </div>
    <div class="pie-recipe__number">2</div>
    <div class="pie-recipe__steps">Pelamos la manzana, quitamos el corazón, la cortamos en trozos y la ponemos en el vaso de la batidora.</div>
    <div class="pie-recipe__number">3</div>
    <div class="pie-recipe__steps">Añadimos el zumo de medio limón o si lo preferís, el zumo de media lima. </div>
    <div class="pie-recipe__number">4</div>
    <div class="pie-recipe__steps">Pelamos el kiwi, lo troceamos y lo añadimos al vaso batidor. Ponemos el agua y batimos con la batidora hasta que no queden grumos. </div>
    <div class="pie-recipe__number">5</div>
    <div class="pie-recipe__steps">Si no queréis encontrar las semillas del kiwi, podéis colar el batido. Este batido de manzana verde y kiwi es una fuente de vitaminas perfecta para tomar en el desayuno. </div>
    ...
    <div class="pie-recipe__tips">
      ...
      <div class="pie-recipe__tips__text">Cada vez están más de moda los jugos verdes y es que tienen multitud de beneficios para nuestro organismo: cuentan con vitaminas, aminoácidos y pocas calorías. En RecetasGratis.net hemos preparado un batido de manzana verde con kiwi, un batido de frutas que nos aporta fibra y ayuda a eliminar líquidos. ¡Esperamos que os guste esta bebida refrescante!</div>
    </div>
  </div>
