...
<head>
    ...
    <link rel="stylesheet" href="../css/rect4_ganarp.css">
    <link rel="stylesheet" href="../css/style.css">
    <title>Pasta cremosa con pollo</title>
</head>
<?php include '../php/modulos/header.php' ?>
<body>

<div class="main-content">
  <div class="navigation">Pasta cremosa con pollo de Atom Rupture</div>
  <div class="pie-image"></div>
  <div class="pie-recipe">
    <div class="pie-recipe__title">
      <div class="pie-name">
         PASTA CREMOSA CON <br/> POLLO</div>
    ...
    <div class="pie-recipe__ingredients">
      <div class="pie-recipe__ingredients__item">
        ...
        <li>1 pimiento rojo (cortado)</li>
        <li>500 g de pechuga de pollo (troceada)</li>
        <li>1 cucharada de condimento cajún</li>
        <li>Sal al gusto</li>
        <li>500 g de pasta</li>
        <li>500 ml de caldo de pollo</li>
        <li>100 g de queso fresco ligero</li>
        <li>Cebollino picado para decorar</li>
    ...
    <div class="pie-recipe__steps"> Primero, calienta el aceite de oliva en una sartén grande antiadherente. Añade la cebolla, los champiñones y las tiras de pimiento y cocina durante unos minutos hasta que se pochen. Retira de la sartén y reserva para más tarde. </div>
    <div class="pie-recipe__number">2</div>
    <div class="pie-recipe__steps">Añade un poco más de aceite de oliva a la sartén si es necesario y añade los trozos de pollo. Cocina el pollo hasta que pierda el color rosado y añade las verduras con el condimento cajún y sal al gusto. Remueve bien para combinar todos los ingredientes.</div>
    <div class="pie-recipe__number">3</div>
    <div class="pie-recipe__steps">A continuación, añade la pasta y el caldo de pollo, tapa la olla y deja que se cocine a fuego lento durante 15 minutos. </div>
    <div class="pie-recipe__number">4</div>
    <div class="pie-recipe__steps">Pasados los 15 minutos, añade el queso crema y remueve para hacer una salsa espesa y cremosa. </div>
    <div class="pie-recipe__number">5</div>
    <div class="pie-recipe__steps">Sirve en platos con un poco de cebollino picado para decorar o espera que se enfríe y guárdalo en tuppers para toda la semana. </div>
    ...
    <div class="pie-recipe__tips">
      ...
      <h4> Pasta cremosa con pollo</h4>
      <div class="pie-recipe__tips__text">¿Hay algún amante de la pasta en la sala? Sí; nosotros también somos muy pasta-friendly, por eso esta vez traemos una deliciosa receta proteica de pasta cremosa con pollo estilo cajún</div>
    </div>
  </div>
