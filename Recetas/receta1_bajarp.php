...
<div class="main-content">
  <div class="navigation">Ensalada de tomate por Atom Rupture</div>
  <div class="pie-image"></div>
  <div class="pie-recipe">
    <div class="pie-recipe__title">
      <div class="pie-name">
         ENSALADA<br/>DE TOMATE</div>
    ...
    <div class="pie-recipe__ingredients">
      <div class="pie-recipe__ingredients__item">
        <h4>Ingredientes</h4>
        <ul>
          <li>2 tomates grandes o 3 medianos</li>
          <li>1 diente de ajo grande</li>
          <li>2 cucharadas de oregano, albahaca u otra hierba de tu preferencia</li>
        <li>Aceite de oliva virgen extra</li>
        <li>un poco de sal</li>
        <li>una pizca de pimienta negra recien molida</li>
        <li>Vinagre balsamico o de jerez (opcional)</li>
        </ul>
        <h4>filling</h4>
        <ul>
    ...
    <div class="pie-recipe__steps"> Para empezar, lavar bien los tomates. Yo me aseguro de eliminar cualquier residuo, remojándolos con agua y un chorro de vinagre (blanco) después de lavarlos. </div>
    <div class="pie-recipe__number">2</div>
    <div class="pie-recipe__steps">Picar los tomates en rueda delgadas y acomodarlos en un bol o plato grande. Hay quienes prefieren pelarlos antes de picar, pero para mi gusto la piel les deja más sabor, nutrientes y fibra.</div>
    <div class="pie-recipe__number">3</div>
    <div class="pie-recipe__steps">Pelar el ajo, y luego triturarlo o picarlo en cubo muy pequeños. </div>
    <div class="pie-recipe__number">4</div>
    <div class="pie-recipe__steps">Esparcir el ajo sobre las ruedas de tomate. Hay que cuidar que los trozos sean realmente pequeños para que el gusto quede uniforme y nadie termine con un bocado sorpresa de ajo tamaño irregular.</div>
    <div class="pie-recipe__number">5</div>
    <div class="pie-recipe__steps">Espolvorear la ensalada con sal y pimienta al gusto.</div>
    <div class="pie-recipe__number">6</div>
    <div class="pie-recipe__steps">Cubrir con un hilo de aceite de oliva, más o menos grueso según el gusto personal, y si se ha decidido utilizar vinagre balsámico, otro de hilo de este último. En caso de añadir más ingredientes a la receta básica de ensalada de tomates, se recomienda moderar la adición de vinagre, para evitar la competencia de sabores.</div>
    ...
    <div class="pie-recipe__tips">
      ...
      <h4>Ensalada de tomates</h4>
      <div class="pie-recipe__tips__text">Vamos a aprender primero cómo hacer ensalada de tomate en su versión más básica. Esta es para muchos la mejor forma de comer tomates y no los culpo 🙂

Es importante escoger siempre tomates jugosos pero a la vez carnosos y firmes, para que no pierdan la forma al cortarlos o se deshagan como agua.</div>
    </div>
  </div>
