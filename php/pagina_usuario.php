...
<body onscroll="Camb()">
    <header id="headt">
           <a href="index.html"> <img src="img/unnamed-removebg-preview.svg" alt="logo" class="logo"></a>
            ...
            <ul class="nav-list">
                ...
                <li><a>Contactos</a></li>
                <li><a>Tienda</a></li>
                <li><button onclick="enviar_form()" class="bo"><p>Hola, Usuario!</p></button></li>
    ...
    <section class="sec2">
        ...
        <div class="sec2-pd">
        <p class="p-3">El asistente de entrenamiento que está</p> <p class="text_red">revolucionando</p> <p class="p-4">el mundo</p>
        </div>
        <div class="bt">
    ...
    <section class="sec3">
        ...
        <div class="contenedor3">
            <div class="cont_items">
                <div class="item1"><svg width="240" height="223" viewBox="0 0 240 223" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="item2"><svg width="202" height="210" viewBox="0 0 202 210" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="item3"><svg width="271" height="266" viewBox="0 0 271 266" fill="none" xmlns="http://www.w3.org/2000/svg">
